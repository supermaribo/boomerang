...
func (s *Server) routesExtra(r chi.Router) {
	...
	r.Get("/settings/tailscale", s.handleGetTailscale)
	r.Put("/settings/tailscale", s.handlePutTailscale)
	r.Post("/settings/tailscale/connect", s.handleTailscaleConnect)
	r.Post("/settings/tailscale/disconnect", s.handleTailscaleDisconnect)
	r.Post("/settings/tailscale/forget", s.handleTailscaleForget)
