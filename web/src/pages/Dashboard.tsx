  ...
  return (
    <div className="shell">
      ...
      <header className="page-head">
        <h1>Dashboard</h1>
        <p className="muted">Recent backups and job activity</p>
      </header>
      ...
      <section className="tile wide dash-section">
      ...
      <p className="muted small pad">Data dir: <code>{data?.dataDir}</code></p>
    </div>
  );
}
